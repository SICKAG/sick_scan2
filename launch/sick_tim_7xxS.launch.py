...
def generate_launch_description():
    ...
    node=Node(
        package='sick_scan2',
        name = 'sick_scan2', # 'sick_scan2_tim_7xxS', # For compatibility with ros versions previous to foxy, node name changed to sick_scan2 for all supported scanner. The type of scanner is configured by scanner_name in the yaml config file.
